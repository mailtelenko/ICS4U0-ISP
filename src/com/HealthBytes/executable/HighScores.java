...
public class HighScores extends MenuParent {
	 ...
	 * 
	 * @return JPanel containing the buttons wrapped in the center.
	 */
	...
	/**
	 * eraseScores opens two connections to the highScores.txt file, one read and
	 * one write. The method reads until it finds no more lines. As it reads it
	 * erases the line afterwards.
	 */
	private void eraseScores() {
		try {
			// Open input to file
			BufferedReader dataIn = new BufferedReader(
					new FileReader(game.getHighScoresPath() + "\\CyberCase\\highscores.txt"));
			// Open output to file
