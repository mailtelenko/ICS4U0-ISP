...
public class Results extends MenuParent {
	...
	public Results(Game gme, int t, int ia, int ic) {
		...
		resultsPanel.add(resultsLabel = new JLabel("<html>"
				+ "<center>Final Score: XXX<br/><br/><br/><br/>Total Time: " + totalTime + " seconds<br/><br/>" + incorrectAnswers + " Incorrect Answers<br/><br/>" + game.getIncorrect() + " Incorrect Clicks</center>"
				+ "</html>"));
